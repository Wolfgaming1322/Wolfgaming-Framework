...
lbClear _units;
CONTROL(2700,2701) ctrlSetStructuredText parseText format ["<t color='#ffffff'>Bank: $%1</t><br/><t color='#ffffff'>Geld: $%2</t>",[BANK] call life_fnc_numberText,[CASH] call life_fnc_numberText];
