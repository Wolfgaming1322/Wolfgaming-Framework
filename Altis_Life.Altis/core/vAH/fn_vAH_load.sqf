...
if (count all_ah_items isEqualTo 0) then {
...
} else {
	{
		...
		_myListbox lbAdd format ["%5 %3 für $%2 von %1, Auktion läuft in %4 Std. aus",_sellerName,[_price] call life_fnc_numberText,_itemName,[_time] call life_fnc_numberText,[_amount] call life_fnc_numberText];
