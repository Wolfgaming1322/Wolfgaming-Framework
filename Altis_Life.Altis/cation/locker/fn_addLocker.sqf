...
if (_queryResult isEqualType "") exitWith {[_pid,_side,_sender] call cat_locker_fnc_fetchLockerTrunk;};
if !(count _queryResult isEqualTo 0) exitWith {[_pid,_side,_sender] call cat_locker_fnc_fetchLockerTrunk;};
...
[_pid,_side,_sender] call cat_locker_fnc_fetchLockerTrunk;