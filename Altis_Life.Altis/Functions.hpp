...
class Life_Client_Core {
    ...
    class Shops {
        ...
        class vehicleShopBuyBank {};
        class buyClothesBank {};
        class weaponShopBuySellBank {};
        class virt_buybank {};
        class licenses {};
...
class TLG_Client {
 tag = "TLG_Client";
 class helpmenu {
 file = "TheLastGamer\helpmenu";
 #include "TheLastGamer\helpmenu\CfgFunctions.hpp"
 };
};
